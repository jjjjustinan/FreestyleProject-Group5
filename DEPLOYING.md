...
Under the "Advanced" options, set an environment variable called `MEALDB_API_KEY` (specifying your own API Key value, without quotes). Also set an environment called `SENDER_ADDRESS` and `SENDGRID_API_KEY` and specify your own unique value.
